    ...
    return __awaiter$8(this, void 0, void 0, function* () {
        const promises = Object.keys(results).map((moduleType) => {
            ...
            const promises = Object.keys(jsModuleList)
                ...
                .map((chunk) => __awaiter$8(this, void 0, void 0, function* () {
...
function emptyOutputTargetDirs(config, compilerCtx) {
    return __awaiter$11(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$11(this, void 0, void 0, function* () {
...
function copyComponentStyles(config, compilerCtx, buildCtx) {
    return __awaiter$13(this, void 0, void 0, function* () {
        ...
        try {
            ...
            absSrcStylePaths.map((absSrcStylePath) => __awaiter$13(this, void 0, void 0, function* () {
                outputTargets.forEach(outputTarget => {
...
function generateTypes(config, compilerCtx, buildCtx, pkgData) {
    return __awaiter$14(this, void 0, void 0, function* () {
        ...
        yield Promise.all(srcDtsFiles.map((srcDtsFile) => __awaiter$14(this, void 0, void 0, function* () {
...
function getGlobalBuildPath(config, outputTarget) {
...
function validatePackageJson(config, outputTarget, diagnostics, pkgData) {
...
function addCoreJs(_config, _appCoreWWWPath, _hostRuleHeaders) {
...
function addBuildDirCacheControl(config, outputTarget, hostConfig) {
    const relPath = pathJoin(config, '/', config.sys.path.relative(outputTarget.dir, getAppBuildDir(config, outputTarget)), '**');
...
function generateCore(config, compilerCtx, buildCtx, outputTarget, globalJsContent, buildConditionals) {
...
function generateGlobalStyles(config, compilerCtx, buildCtx, outputTarget) {
    return __awaiter$28(this, void 0, void 0, function* () {
        ...
        try {
            const styles = yield Promise.all(filePaths.map((filePath) => __awaiter$28(this, void 0, void 0, function* () {
                filePath = normalizePath(filePath);
...
function setBuildConditionals(config, compilerCtx, buildCtx, entryModules) {
...
function generateAppFilesOutputTarget(config, compilerCtx, buildCtx, outputTarget, entryModules, cmpRegistry) {
    return __awaiter$31(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const buildConditionals = yield setBuildConditionals(config, compilerCtx, buildCtx, entryModules);
            buildConditionals.coreId = 'core';
            const coreFilename = yield generateCore(config, compilerCtx, buildCtx, outputTarget, globalJsContentsEs2015, buildConditionals);
            ...
            if (config.buildEs5) {
                ...
                const buildConditionalsEs5 = yield setBuildConditionals(config, compilerCtx, buildCtx, entryModules);
                ...
                const coreFilenameEs5 = yield generateCore(config, compilerCtx, buildCtx, outputTarget, globalJsContentsEs5, buildConditionalsEs5);
            ...
            yield writeAppRegistry(config, compilerCtx, outputTarget, appRegistry, cmpRegistry);
            // create the loader(s) after creating the loader file name
            yield generateLoader(config, compilerCtx, outputTarget, appRegistry, cmpRegistry);
...
function generateBundles(config, compilerCtx, buildCtx, entryModules, jsModules) {
    return __awaiter$32(this, void 0, void 0, function* () {
        ...
        const bundleKeys = {};
        yield Promise.all(entryModules.map((entryModule) => __awaiter$32(this, void 0, void 0, function* () {
            ...
            return Promise.all(entryModule.modeNames.map((modeName) => __awaiter$32(this, void 0, void 0, function* () {
        ...
        const esmPromises = Object.keys(esmModules)
            ...
            .map(([key, value]) => __awaiter$32(this, void 0, void 0, function* () {
...
function generateBundleBuild(config, compilerCtx, entryModule, jsText, bundleId, modeName, isScopedStyles, sourceTarget) {
    return __awaiter$32(this, void 0, void 0, function* () {
        ...
        return Promise.all(outputTargets.map((outputTarget) => __awaiter$32(this, void 0, void 0, function* () {
...
function generateJsons(config, compilerCtx) {
    return Promise.resolve();
}
// {
//   tag: 'ion-button',
...
function genereateReadme(config, ctx, readmeOutputs, moduleFile, dirPath) {
...
function createReadme(config, ctx, readmeOutputs, moduleFile, readMePath) {
    return __awaiter$33(this, void 0, void 0, function* () {
        const content = [];
        ...
        yield ctx.fs.writeFiles(writeFiles);
    });
}
function updateReadme(config, ctx, readmeOutputs, moduleFile, readMePath, existingContent) {
    return __awaiter$33(this, void 0, void 0, function* () {
        if (typeof existingContent !== 'string' || existingContent.trim() === '') {
...
function generateComponentTypes(config, compilerCtx, buildCtx, tsOptions, tsHost, tsFilePaths, componentsDtsSrcFilePath) {
    return __awaiter$36(this, void 0, void 0, function* () {
        ...
        yield Promise.all(typesOutputTargets.map((outputTarget) => __awaiter$36(this, void 0, void 0, function* () {
...
function scanDirForTsFiles(config, fs$$1, dir) {
    return __awaiter$38(this, void 0, void 0, function* () {
        ...
        yield Promise.all(tsFileItems.map((tsFileItem) => __awaiter$38(this, void 0, void 0, function* () {
...
function generateDocOutputTarget(config, compilerCtx, outputTarget) {
    return __awaiter$39(this, void 0, void 0, function* () {
...
function generateStyles(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$41(this, void 0, void 0, function* () {
        yield Promise.all(entryModules.map((bundle) => __awaiter$41(this, void 0, void 0, function* () {
            yield Promise.all(bundle.moduleFiles.map((moduleFile) => __awaiter$41(this, void 0, void 0, function* () {
...
function generateComponentStyles(config, compilerCtx, buildCtx, moduleFile) {
    return __awaiter$41(this, void 0, void 0, function* () {
        ...
        yield Promise.all(Object.keys(stylesMeta).map((modeName) => __awaiter$41(this, void 0, void 0, function* () {
...
function compileExternalStyle(config, compilerCtx, buildCtx, moduleFile, extStylePath) {
    return __awaiter$41(this, void 0, void 0, function* () {
        ...
        if (!moduleFile.isCollectionDependency) {
            ...
            yield Promise.all(collectionDirs.map((outputTarget) => __awaiter$41(this, void 0, void 0, function* () {
...
function createDoUpgrade(config, compilerCtx, buildCtx) {
    return (collection, upgrades) => __awaiter$44(this, void 0, void 0, function* () {
        ...
        yield Promise.all(collection.moduleFiles.map((moduleFile) => __awaiter$44(this, void 0, void 0, function* () {
            try {
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$45(this, void 0, void 0, function* () {
        ...
        return Promise.all(uninitialized.map((collection) => __awaiter$45(this, void 0, void 0, function* () {
...
function getWritePathFromUrl(config, outputTarget, url) {
    ...
    const dir = config.sys.path.join(outputTarget.dir, pathName);
...
function versionElementTypeAsset(config, compilerCtx, outputTarget, windowLocationHref, elm, attrName) {
    return __awaiter$47(this, void 0, void 0, function* () {
...
function insertCanonicalLink(config, doc, windowLocationPath) {
...
function createPlatformServer(config, outputTarget, win, doc, cmpRegistry, diagnostics, isPrerender, compilerCtx) {
    const loadedBundles = {};
    const styles = [];
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        // create the platform
        const plt = createPlatformServer(config, hydrateTarget, win, doc, cmpRegistry, hydrateResults.diagnostics, hydrateTarget.isPrerender, compilerCtx);
        // fire off this function when the app has finished loading
        // and all components have finished hydrating
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$53(this, void 0, void 0, function* () {
            if (config._isTesting) {
...
function prerenderOutputTargets(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$56(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$56(this, void 0, void 0, function* () {
...
function writeBuildFiles(config, compilerCtx, buildCtx) {
    return __awaiter$59(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield generateServiceWorkers(config, compilerCtx, buildCtx);
